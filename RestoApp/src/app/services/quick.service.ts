...
export class QuickService {
    ...
    vegans: Food[] = [
        { id: 2, title: 'Siccilia', description: 'The vegan food', price: 7.0 },
        { id: 2, title: 'DiMare', description: 'The real vegan food', price: 6.0 },
        { id: 2, title: 'Terra', description: 'The real vegan food', price: 8.0 }
    ];

    desserts: Food[] = [
        { id: 3, title: 'PannaCotta', description: 'The real PananCotta Dessert', price: 7.0 },
        { id: 3, title: 'Tiramissu', description: 'The real Tiramissu Dessert', price: 6.0 },
